...
class RecipeModel{
  ...
  static List<RecipeModel> demoRecipes = [
    ...
    RecipeModel(
      ...
      ingredients: [
        Ingredient(quantity: "500 гр.", title: "Треска"),
        Ingredient(quantity: "0.5 шт.", title: "Лимон"),
        Ingredient(quantity: "1 ст. л.", title: "Оливковое масло"),
        Ingredient(quantity: "1 шт.", title: "Лук репчатый"),
        Ingredient(quantity: "150 гр.", title: "Сыр твердый"),
        Ingredient(quantity: "по вкусу", title: "Соль"),
        Ingredient(quantity: "по вкусу", title: "Перец черный молотый"),
      ],
      steps: [
    ...
    RecipeModel(
      ...
      ingredients: [
        Ingredient(quantity: "400 гр.", title: "Филе рыбы"),
        Ingredient(quantity: "1 шт.", title: "Лук репчатый"),
        Ingredient(quantity: "1 шт.", title: "Морковь"),
        Ingredient(quantity: "1 шт.", title: "Яйцо"),
        Ingredient(quantity: "200 гр.", title: "Сыр твердый"),
        Ingredient(quantity: "100 гр.", title: "Сметана"),
        Ingredient(quantity: "по вкусу", title: "Соль"),
        Ingredient(quantity: "по вкусу", title: "Перец черный молотый"),
      ],
    ...
    RecipeModel(
      ...
      ingredients: [
        Ingredient(quantity: "300 гр.", title: "Кабачки"),
        Ingredient(quantity: "300 гр.", title: "Баклажаны"),
        Ingredient(quantity: "1 кг.", title: "Помидоры"),
        Ingredient(quantity: "2 шт.", title: "Болгарский перец"),
        Ingredient(quantity: "2 шт.", title: "Лук"),
        Ingredient(quantity: "3 зуб.", title: "Чеснок"),
        Ingredient(quantity: "50 мл.", title: "Растительное масло"),
        Ingredient(quantity: "по вкусу", title: "Соль"),
        Ingredient(quantity: "по вкусу", title: "Специи сухие"),
      ],
      steps: [
    ...
    RecipeModel(
      ...
      ingredients: [
        Ingredient(quantity: "700 гр.", title: "Минтай"),
        Ingredient(quantity: "3 стол. л.", title: "Мука"),
        Ingredient(quantity: "3 зуб.", title: "Чеснок"),
        Ingredient(quantity: "40 мл.", title: "Растительное масло"),
        Ingredient(quantity: "по вкусу", title: "Тимьян, чабрец"),
        Ingredient(quantity: "по вкусу", title: "Соль"),
        Ingredient(quantity: "по вкусу", title: "Специи сухие"),
      ],
      steps: [
    ...
    RecipeModel(
      ...
      ingredients: [
        Ingredient(quantity: "150 гр.", title: "Фасоль стручковая зеленая"),
        Ingredient(quantity: "150 гр.", title: "Цукини"),
        Ingredient(quantity: "1 шт.", title: "Лук"),
        Ingredient(quantity: "1 шт.", title: "Болгарский перец"),
        Ingredient(quantity: "1 шт.", title: "Морковь"),
        Ingredient(quantity: "150 гр.", title: "Баклажаны"),
        Ingredient(quantity: "по вкусу", title: "Имбирь"),
        Ingredient(quantity: "2 зуб.", title: "Чеснок"),
        Ingredient(quantity: "4 стол. л.", title: "Растительное масло"),
        Ingredient(quantity: "2 чайн. л.", title: "Кунжутное масло"),
        Ingredient(quantity: "3 стол. л.", title: "Соевый соус"),
        Ingredient(quantity: "1 чайн. л.", title: "Кунжут"),
      ],
      steps: [
    ...
    RecipeModel(
      ...
      ingredients: [
        Ingredient(quantity: "200 гр.", title: "Рис"),
        Ingredient(quantity: "1 чайн. л.", title: "Соль"),
        Ingredient(quantity: "30 гр.", title: "Сливочное масло"),
      ],
      steps: [
